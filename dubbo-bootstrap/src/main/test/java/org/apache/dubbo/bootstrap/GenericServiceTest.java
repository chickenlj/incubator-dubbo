...
public class GenericServiceTest {
    ...
    public void testGenericInvokeWithBeanSerialization() throws Exception {
        ...
        service.setProtocol(new ProtocolConfig("dubbo", 29581));
        service.export();
        ReferenceConfigBuilder<GenericService> reference = null;
        try {
            reference = new ReferenceConfigBuilder<GenericService>();
    ...
    public void testGenericImplementationWithBeanSerialization() throws Exception {
        ...
        service.export();
        ReferenceConfigBuilder<DemoService> ref = null;
        try {
            ref = new ReferenceConfigBuilder<DemoService>();
