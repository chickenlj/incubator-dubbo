 ...
 */
package org.apache.dubbo.bootstrap.cache;
...
public class CacheTest extends TestCase {
    ...
    private void testCache(String type) throws Exception {
        ServiceConfigBuilder<CacheService> service = new ServiceConfigBuilder<CacheService>();
        ...
        service.export();
        try {
            ReferenceConfigBuilder<CacheService> reference = new ReferenceConfigBuilder<CacheService>();
