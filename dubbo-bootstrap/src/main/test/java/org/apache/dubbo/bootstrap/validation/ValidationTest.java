 ...
 */
package org.apache.dubbo.bootstrap.validation;
...
public class ValidationTest {
    ...
    public void testValidation() {
        ServiceConfigBuilder<ValidationService> service = new ServiceConfigBuilder<ValidationService>();
        ...
        service.export();
        try {
            ReferenceConfigBuilder<ValidationService> reference = new ReferenceConfigBuilder<ValidationService>();
    ...
    public void testGenericValidation() {
        ...
        service.export();
        try {
            ReferenceConfigBuilder<GenericService> reference = new ReferenceConfigBuilder<GenericService>();
            reference.setApplication(new ApplicationConfig("validation-consumer"));
