...
import org.apache.dubbo.bootstrap.mock.MockProtocol2;
import org.apache.dubbo.bootstrap.mock.MockRegistryFactory2;
import org.apache.dubbo.bootstrap.mock.TestProxyFactory;
...
public class ServiceConfigBuilderTest {
    ...
    private ServiceConfigBuilder<DemoServiceImpl> service = new ServiceConfigBuilder<DemoServiceImpl>();
    private ServiceConfigBuilder<DemoServiceImpl> service2 = new ServiceConfigBuilder<DemoServiceImpl>();
