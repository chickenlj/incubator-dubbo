 ...
 */
package org.apache.dubbo.bootstrap.url;

import org.apache.dubbo.bootstrap.ReferenceConfigBuilder;
import org.apache.dubbo.bootstrap.mock.MockRegistry;
...
public class InvokerSideConfigUrlTest extends UrlTestBase {
    ...
    private ReferenceConfigBuilder<DemoService> refConf;
...
//            {"", "", "", "", "", "", "", "", "", ""}, 
    ...
    private void initRefConf() {
        ...
        refConf = new ReferenceConfigBuilder<>();
        ...
        refConf.setInterface("org.apache.dubbo.test.config.api.DemoService");
