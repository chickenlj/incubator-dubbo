 ...
 */
package com.alibaba.dubbo.config.configcenter;
...
import static com.alibaba.dubbo.common.Constants.ANYHOST_VALUE;
import static com.alibaba.dubbo.common.Constants.BACKUP_KEY;
import static com.alibaba.dubbo.common.Constants.CONFIG_APP_CONFIGFILE_KEY;
import static com.alibaba.dubbo.common.Constants.CONFIG_CONFIGFILE_KEY;
import static com.alibaba.dubbo.common.Constants.CONFIG_ENABLE_KEY;
import static com.alibaba.dubbo.common.Constants.DEFAULT_DUBBO_PROPERTIES;
...
public class ConfigCenterConfig extends AbstractConfig {
    ...
    */
    private String configFile = DEFAULT_DUBBO_PROPERTIES;
    ...
    public URL toUrl() {
        ...
        if (StringUtils.isEmpty(map.get(PROTOCOL_KEY))) {
            map.put(PROTOCOL_KEY, "zookeeper");
        }
    ...
    public void setAddress(String address) {
        ...
        if (address != null) {
            try {
                ...
                if (StringUtils.isEmpty(getUsername()) && StringUtils.isNotEmpty(url.getUsername())) {
                    this.setUsername(url.getUsername());
                }
                if (StringUtils.isEmpty(getPassword()) && StringUtils.isNotEmpty(url.getPassword())) {
                    this.setPassword(url.getPassword());
                }
                if (getPort() == null && url.getPort() != 0) {
                    this.setPort(url.getPort());
                }
                if (StringUtils.isEmpty(getProtocol()) && StringUtils.isNotEmpty(url.getProtocol())) {
