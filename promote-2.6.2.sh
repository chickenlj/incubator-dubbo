...
# mv https://dist.apache.org/repos/dist/dev/incubator/dubbo/2.6.2 https://dist.apache.org/repos/dist/release/incubator/dubbo/ -m "Upload release to the mirrors"
