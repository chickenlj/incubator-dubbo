...
svn mv https://dist.apache.org/repos/dist/dev/wicket/2.6.2-SNAPSHOT-SNAPSHOT https://dist.apache.org/repos/dist/release/wicket -m "Upload release to the mirrors"
