 ...
 */
package com.alibaba.dubbo.rpc.cluster.router.condition.matcher.argument;
...
public class ArgumentConditionMatcher extends AbstractConditionMatcher {
    private static final Logger logger = LoggerFactory.getLogger(ArgumentConditionMatcher.class);
    ...
    public String getValue(Map<String, String> sample, URL url, Invocation invocation) {
        try {
            ...
            logger.warn("Parse argument match condition failed!", e);
        }
        return DOES_NOT_FOUND_VALUE;
    }
}
