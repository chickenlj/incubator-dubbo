 ...
 */
package com.alibaba.dubbo.rpc.cluster.router.condition.matcher.param;
...
public class UrlParamConditionMatcherFactory implements ConditionMatcherFactory {
    ...
    @Override
    public ConditionMatcher createMatcher(String key) {
        return new UrlParamConditionMatcher(key);
    }
}
